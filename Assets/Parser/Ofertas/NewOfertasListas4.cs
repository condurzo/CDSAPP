...
public class NewOfertasListas4 : MonoBehaviour {
	...
	IEnumerator Start(){
		...
		string url = "http://158.69.197.37:8080/api/product/byAppliance?applianceID="+PlayerPrefs.GetString("ListaId4");;
		WWW www = new WWW(url);
		...
		if (www.error == null){
			...
			Debug.Log("Ofertas Lista 4" + www.data);
